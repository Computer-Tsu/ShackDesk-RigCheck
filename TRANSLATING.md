...
| --- | --- | --- | --- |
| English (source) | `Strings.resx` | 100% (367 of 367) | Source |
| German (`de`) | `Strings.de.resx` | 100% (367 of 367) | Machine translated — review wanted |
| Spanish (`es`) | `Strings.es.resx` | 100% (367 of 367) | Machine translated — review wanted |
| French (`fr`) | `Strings.fr.resx` | 100% (367 of 367) | Machine translated — review wanted |
| Japanese (`ja`) | `Strings.ja.resx` | 100% (367 of 367) | Machine translated — review wanted |
<!-- coverage:end -->
